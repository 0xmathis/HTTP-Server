...
<header>
    ...
    <nav>
        <ul>
            ...
            <li/><h2 class="menu"><a href="page1.html">Page1</a></h2>
            <li/><h2 class="menu"><a href="page_php.php">Page2</a></h2>
...
<section>
    ...
    <form action="result_php.php" method="GET">
        ...
        <h3> Histoire:</h3>
        <p>
            <label for="foot">En quelle année la sélection espagnole a-t-elle été sacrée championne  du monde de football ? </var> </label>
